package at.thoms.utils.capabilities;

import at.thoms.interfaces.IWork;
...
public class Worker implements IWork, INBTSerializable<NBTTagCompound> {
	...
	/**
	 * Should Add Cooldown Ticks when Cooldown is not 0. Added by me
	 * 
	 * @param maxcooldown
	 * @return
	 */

	public Worker setAdditionalCooldown(int maxcooldown) {
		this.cooldown = cooldown += maxcooldown;
		return this;
	}
