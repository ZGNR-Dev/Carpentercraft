...
/**
 * This class is blatantly stolen from iChunUtils without permission.
 *
 * @author iChun
 */
public class GuiVerticalSlider extends GuiButtonExt
{
    ...
    public IVerticalSlider parent = null;
    ...
    public GuiVerticalSlider(int id, int xPos, int yPos, int width, int height, String prefix, String suf, double minVal, double maxVal, double currentVal, boolean showDec, boolean drawStr, IVerticalSlider par)
    {
    ...
    public GuiVerticalSlider(int id, int xPos, int yPos, String displayStr, double minVal, double maxVal, double currentVal, IVerticalSlider par)
    {
...
//            this.drawTexturedModalRect(this.yPosition + (int)(this.sliderValue * (float)(this.height - 8)), this.xPosition, 0, 66, 4, 20);;
            this.drawTexturedModalRect(this.xPosition + (int)(this.sliderValue * (float)(this.width - 8)) + 4, this.yPosition, 196, 66, 4, 20);
//            this.drawTexturedModalRect(this.yPosition + (int)(this.sliderValue * (float)(this.height - 8)) + 4, this.xPosition, 196, 66, 4, 20);
        }
    }
    ...
    public static interface IVerticalSlider
    {
