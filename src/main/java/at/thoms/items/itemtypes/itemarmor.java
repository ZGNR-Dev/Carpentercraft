...
public class itemarmor extends Item
{
    ...
    private final itemarmor.ArmorMaterials material;
    ...
    public itemarmor(itemarmor.ArmorMaterials materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn)
    {
     ...
     */
    public itemarmor.ArmorMaterials getArmorMaterial()
    {
    ...
    {
        if (this.material != itemarmor.ArmorMaterials.LEATHER)
        {
            return false;
        }
        else
    ...
    {
        return this.material == itemarmor.ArmorMaterials.LEATHER || getColor(stack) != 0x00FFFFFF;
    }
