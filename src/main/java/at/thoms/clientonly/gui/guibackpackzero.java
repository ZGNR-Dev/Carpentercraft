...
public class guibackpackzero extends GuiContainer {
	
	private InventoryPlayer playerInv;
	private static final ResourceLocation bgtexturebackpackzero = new ResourceLocation(Carpentercraft.MODID, "textures/gui/backpack0.png");

	public guibackpackzero(Container container, InventoryPlayer playerInv) {
		super(container);
