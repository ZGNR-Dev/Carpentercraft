...
public class Recipeshotcrafting implements IRecipe
{
    ...
    public Recipeshotcrafting(Block result, Object... recipe){ this(new ItemStack(result), recipe); }
    public Recipeshotcrafting(Item result, Object... recipe){ this(new ItemStack(result), recipe); }
    public Recipeshotcrafting(ItemStack result, Object... recipe)
    {
        output = result.copy();
