...
public class Recipesblockcreator implements IRecipe
{
    //Added in for future ease of change, but hard coded for now. TODO Add Millibuckets of UU
    private static final int MAX_CRAFT_GRID_WIDTH = 1;
    ...
    public Recipesblockcreator(Block result, Object... recipe){ this(new ItemStack(result), recipe); }
    public Recipesblockcreator(Item result, Object... recipe){ this(new ItemStack(result), recipe); }
    public Recipesblockcreator(ItemStack result, Object... recipe)
    {
        output = result.copy();
    ...
    public Recipesblockcreator(Item result, int sliderOne, int sliderTwo, int sliderTre) {
    	this(new ItemStack(result), sliderOne, sliderTwo, sliderTre);
	}
