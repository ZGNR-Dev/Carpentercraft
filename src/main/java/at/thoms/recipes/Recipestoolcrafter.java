...
public class Recipestoolcrafter implements IRecipe
{
    ...
    public Recipestoolcrafter(Block result, Object... recipe){ this(new ItemStack(result), recipe); }
    public Recipestoolcrafter(Item result, Object... recipe){ this(new ItemStack(result), recipe); }
    public Recipestoolcrafter(ItemStack result, Object... recipe)
    {
        output = result.copy();
