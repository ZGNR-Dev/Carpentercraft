...
public class Inventorybackpackzero implements IInventory
{
    ...
    public final ItemStack[] backpackzeroInventory = new ItemStack[4];
     ...
     */
    public static boolean inventoryChanged;

//    public Inventorybackpackzero(EntityPlayer playerIn)
//    {
    public Inventorybackpackzero(ItemStack stack) {
        this.allInventories = new ItemStack[][] {this.mainInventory, this.armorInventory, this.offHandInventory, this.backpackzeroInventory};
...
//        this.itemStack = itemStack;
    ...
    private int storeItemStack(ItemStack itemStackIn)
    {
        ...
        else if (this.canMergeStacks(this.getStackInSlot(50), itemStackIn))
        {
            return 50;
        }
        else
    ...
    public NBTTagList writeToNBT(NBTTagList nbtTagListIn)
    {
        ...
        for (int l = 0; l < this.backpackzeroInventory.length; ++l)
        {
            if (this.backpackzeroInventory[l] != null)
            {
                NBTTagCompound nbttagcompound3 = new NBTTagCompound();
                nbttagcompound3.setByte("Slot", (byte)(l + 200));
                this.backpackzeroInventory[l].writeToNBT(nbttagcompound3);
    ...
    public void readFromNBT(NBTTagList nbtTagListIn)
    {
        ...
        Arrays.fill(this.backpackzeroInventory,  (Object)null);
        ...
        for (int i = 0; i < nbtTagListIn.tagCount(); ++i)
        {
            ...
            if (itemstack != null)
            {
                ...
                else if( j >= 200 && j < this.backpackzeroInventory.length + 200){
                	this.backpackzeroInventory[j - 200] = itemstack;
                }
            }
            
    		if(tag == null){
    			writeToNBT(nbtTagListIn);
    			return ;
    		}
    		...
    		for(int o = 0; o < list.tagCount(); o++) {
    			NBTTagCompound slotTag = list.getCompoundTagAt(o);
    ...
    {
        return this.mainInventory.length + this.armorInventory.length + this.offHandInventory.length + this.backpackzeroInventory.length;
    }
     ...
     */
    public void copyInventory(Inventorybackpackzero playerInventory)
    {
