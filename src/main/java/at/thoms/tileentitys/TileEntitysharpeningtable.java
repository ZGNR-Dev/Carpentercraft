...
import at.thoms.container.containersharpeningtable;
...
public class TileEntitysharpeningtable extends TileEntity implements ITickable, ISidedInventory
{
...
//            }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = Recipessharpeningtable.instance().getSmeltingResult(this.furnaceItemStacks[0]);
    ...
    public static int getItemSharpeningTime(ItemStack stack)
    {
        ...
        else
        {
            ...
            if (item == Carpentercraft.whetstone) return 200;
    ...
    {
        return "minecraft:sharpeningtable";
    }

    public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn)
    {
        return new containersharpeningtable(playerInventory, this);
    }
