...
public class blockcreatorCraftingManager
{
    /** The static instance of this class */
    private static final blockcreatorCraftingManager instance = new blockcreatorCraftingManager();
     ...
     */
    public static blockcreatorCraftingManager getInstance()
    {
        /** The static instance of this class */
        return instance;
    }
    ...
    private blockcreatorCraftingManager()
    {
        //Add recipes here

        //Vanilla
    	addRecipe(new ItemStack(Carpentercraft.bee), 3, 3, 3);
